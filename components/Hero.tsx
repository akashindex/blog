...
const Hero = () => {
  return (
    ...
    <div className="w-[90%] md:w-[80%] flex flex-col p-[20px] sm:p-[30px] justify-center">
      <div className="text-black font-bold text-[24px] sm:text-[30px] lg:text-[40px] uppercase mb-6 sm:mb-10 mt-6 sm:mt-10">
        Teen Patti Gold Pakistan APK Download <br /> (Latest Version) v1.629 for Android
      </div>
      <p className="text-black text-[14px] sm:text-[16px] lg:text-[20px] w-full mt-2 sm:mt-4 mb-2 sm:mb-4">
